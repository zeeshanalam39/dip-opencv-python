...
img = cv.imread('D:\@Semester 06\Digital Image Processing\Lab\Manuals\Figures\lab4\_img1.tif', 0)
original = cv.imread('D:\@Semester 06\Digital Image Processing\Lab\Manuals\Figures\lab4\_img1.tif', 0)
...
# ----- Global Enhancement starts here -----
...
# ----- Global Enhancement ends here -----

# ----- Local Enhancement starts here -----
m = n = 3   # Window size
mid = round((m * n) / 2)


cv.imshow('Original', original)
cv.imshow('Enhanced Globally', img)   # Show enhanced image
# cv.imshow('Enhanced Locally', localImg)
cv.waitKey(20000)
